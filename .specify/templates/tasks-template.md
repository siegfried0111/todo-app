...
- Tests MUST be written FIRST and FAIL before implementation (TDD Red phase - NON-NEGOTIABLE)
- Implementation MUST make tests pass (TDD Green phase)
- Refactoring with tests still passing (TDD Refactor phase)
...
- Commit after each task or logical group (ideally after each Red-Green-Refactor cycle)
- Stop at any checkpoint to validate story independently
- Code quality: Keep functions under 50 lines, complexity under 10, use meaningful names
